...
from c_storage_layer.flight_io import Flight_IO
from c_storage_layer.destination_io import Destination_IO
from c_storage_layer.employee_io import Employee_IO


class Voyage_IO:
    def __init__(self, employee_io, destination_io, flight_io) -> tuple:
        self.file_path = "c_storage_layer/storage/voyages.csv"
